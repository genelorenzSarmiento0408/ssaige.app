    ...
    <div className="min-h-screen bg-linear-to-br from-teal-50 via-white to-emerald-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <Repeat className="w-8 h-8 text-teal-600 mb-3" />
        ...
        <div className="text-center">
          <Link
            href="/upload"
            className="inline-flex items-center px-8 py-4 bg-teal-600 text-white rounded-full hover:bg-teal-700 transition-colors font-semibold"
          >

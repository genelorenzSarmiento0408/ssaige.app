    ...
    >
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2">
              <div
                className={`w-10 h-10 bg-linear-to-br from-${colors.primary}-600 to-${colors.secondary}-600 rounded-xl flex items-center justify-center`}
              >
                <Sparkles className="w-6 h-6 text-white" />
              </div>
              <span
                className={`font-bold text-xl bg-linear-to-r from-${colors.primary}-600 to-${colors.secondary}-600 bg-clip-text text-transparent`}
              >
                SSAIGE
              </span>
            </Link>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="text-center mb-8">
          <h1
            className={`text-4xl font-bold mb-4 bg-linear-to-r from-${colors.primary}-600 via-${colors.secondary}-600 to-${colors.accent}-500 bg-clip-text text-transparent`}
          >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex gap-4 mb-6">
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all ${
                sourceType === "text"
                  ? `bg-linear-to-r from-${colors.primary}-600 to-${colors.secondary}-600 text-white shadow-lg`
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {sourceType === "text" ? (
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-${colors.primary}-500 focus:outline-none min-h-[300px]`}
                  required
                />
              </div>
            ) : sourceType === "file" ? (
              <div>
                ...
                <div
                  ...
                  className={`border-2 border-dashed rounded-xl p-8 text-center transition-all ${
                    dragActive
                      ? `border-${colors.primary}-500 bg-${colors.primary}-50`
                ...
                >
                  {file ? (
                    <div className="space-y-4">
                      <File
                        className={`w-16 h-16 mx-auto text-${colors.primary}-600`}
                      />
                      <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-linear-to-r from-${colors.primary}-600 to-${colors.secondary}-600 text-white py-4 rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2`}
            >
              {loading ? (
                <>
          ...
          {/* Info Box */}
          <div
            className={`mt-6 bg-${colors.primary}-50 border-2 border-${colors.primary}-200 rounded-xl p-4`}
          >
            <p className={`text-sm text-${colors.primary}-900`}>
              <strong>📚 What happens next:</strong> Our AI will analyze your
              content and automatically generate:
            </p>
            <ul
              className={`mt-2 space-y-1 text-sm text-${colors.primary}-800 ml-4`}
            >
            ...
            {sourceType === "file" && (
              <p className={`text-xs text-${colors.primary}-700 mt-3`}>
